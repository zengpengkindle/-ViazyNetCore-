...
namespace ViazyNetCore.Modules
{
    ...
    public interface IUserRepository : IBaseRepository<BmsUser, long>
    {
        ...
        Task<PageData<UserFindAllModel>> FindAllAsync(string usernameLike, long roleId, ComStatus? status, Pagination args);
        ...
        /// <param name="salt">密码盐</param>
        /// <returns></returns>
        Task ModifyMerchantPasswordById(long id, string newPassword, Guid salt);
        ...
        /// </summary>
        /// <returns></returns>
        Task<List<BmsUser>> CheckDefaultPassword();
