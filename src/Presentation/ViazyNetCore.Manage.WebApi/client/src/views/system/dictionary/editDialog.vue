...
<template>
    <el-drawer v-model="visible" size="35%" :title="id ? '编辑字典' : '新增字典'" :before-close="handleClose">
        <el-form ref="formRef" :model="dicInfo" :rules="rules" label-width="100px" class="demo-ruleForm">
            <el-form-item label="名称" prop="name">
                <el-input v-model="dicInfo.name" type="text" :disabled="id ? true : false" />
            </el-form-item>
            ...
            <el-form-item label="状态" prop="status">
                <el-input :rows="3" v-model="dicInfo.description" type="textarea" autocomplete="off" />
            </el-form-item>
            <el-form-item>
