...
{
    public class MinioOSSService : ObjectStorageServiceBase, IMinioOSSService
    {
        ...
        public async Task<PolicyInfo> GetPolicyAsync(string bucketName)
        {
            try
            {
                ...
                return JSON.Parse<PolicyInfo>(policyJson);
            }
        ...
        public async Task<bool> SetPolicyAsync(string bucketName, List<StatementItem> statements)
        {
            ...
            string policyJson = JSON.Stringify(info);
        ...
        public Task<List<Item>> ListObjectsAsync(string bucketName, string prefix = null)
        {
            ...
            IObservable<DataModel.Item> observable = _client.ListObjectsAsync(
                new ListObjectsArgs()
                    .WithBucket(bucketName)
                    .WithPrefix(prefix)
                    .WithRecursive(true));
