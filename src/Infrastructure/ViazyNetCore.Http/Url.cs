...
namespace ViazyNetCore.Http
{
    ...
    public class Url
    {
        ...
        /// <summary>
        /// Parses a URL string into a Caesar.Url object.
        /// </summary>
        ...
        public Url AppendPathSegment(object segment, bool fullyEncode = false)
        {
            ...
            if (fullyEncode)
            {
                PathSegments.Add(Uri.EscapeUriString(segment.ToInvariantString()));
                _trailingSlash = false;
            }
            else
            {
        ...
        /// <summary>
        /// Implicit conversion from System.Uri to Caesar.Url.
        /// </summary>
        /// <returns>The string</returns>
