...
//	{
//		private readonly List<Func<CaesarCall, bool>> _filters = new List<Func<CaesarCall, bool>>();

//		/// <summary>
//		/// Constructs a new instance of FilteredHttpTestSetup.
//		/// </summary>
//		/// <param name="settings">CaesarHttpSettings used in fake calls.</param>
//		/// <param name="urlPatterns">URL(s) or URL pattern(s) that this HttpTestSetup applies to. Can contain * wildcard.</param>
//		public FilteredHttpTestSetup(TestCaesarHttpSettings settings, params string[] urlPatterns) : base(settings) {
//			if (urlPatterns.Any())
//				With(call => urlPatterns.Any(p => Util.MatchesPattern(call.Request.Url, p)));
//		}

//		/// <summary>
//		/// Returns true if the given CaesarCall matches one of the URL patterns and all other criteria defined for this HttpTestSetup.
//		/// </summary>
//		internal bool IsMatch(CaesarCall call) => _filters.All(f => f(call));

//		/// <summary>
//		/// Defines a condition for which this HttpTestSetup applies.
//		/// </summary>
//		public FilteredHttpTestSetup With(Func<CaesarCall, bool> condition) {
...
//		/// </summary>
//		public FilteredHttpTestSetup Without(Func<CaesarCall, bool> condition) {
