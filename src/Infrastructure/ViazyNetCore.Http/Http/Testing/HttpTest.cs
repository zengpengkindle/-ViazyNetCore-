...
//{
//	/// <summary>
//	/// An object whose existence puts Caesar.Http into test mode where actual HTTP calls are faked. Provides a response
...
//	{
//		private readonly ConcurrentQueue<CaesarCall> _calls = new ConcurrentQueue<CaesarCall>();
...
//		public HttpTest() : base(new TestCaesarHttpSettings()) {
...
//		internal void LogCall(CaesarCall call) => _calls.Enqueue(call);
...
//		/// </summary>
//		public IReadOnlyList<CaesarCall> CallLog => new ReadOnlyCollection<CaesarCall>(_calls.ToList());

//		/// <summary>
//		/// Change CaesarHttpSettings for the scope of this HttpTest.
//		/// </summary>
//		/// <param name="action">Action defining the settings changes.</param>
//		/// <returns>This HttpTest</returns>
//		public HttpTest Configure(Action<TestCaesarHttpSettings> action) {
//			action(Settings);
//			return this;
//		}
...
//		internal HttpTestSetup FindSetup(CaesarCall call) {
