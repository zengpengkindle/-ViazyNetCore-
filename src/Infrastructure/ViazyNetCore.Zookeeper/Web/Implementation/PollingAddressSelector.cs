...
using ViazyNetCore.Zookeeper.Web.Routing;
...
namespace ViazyNetCore.Zookeeper.Web
{
    ...
    public class PollingAddressSelector : AddressSelectorBase
    {
        ...
        public PollingAddressSelector(IServiceRouteManager serviceRouteManager, IHealthCheckService healthCheckService)
        {
            ...
            //路由发生变更时重建地址条目。
            serviceRouteManager.Changed += this.ServiceRouteManager_Removed;
            serviceRouteManager.Removed += this.ServiceRouteManager_Removed;
        }
