...
namespace ViazyNetCore.Modules
{
    ...
    public class PageRepository : DefaultRepository<BmsPage, long>, IPageRepository
    {
        ...
        public PageRepository(IFreeSql fsql, ICacheService cacheService, IRolePageRepository rolePageRepository,IOptions<UserOption> options) : base(fsql)
        {
            ...
            return _cacheService.GetAsync(string.Format(BMS_PAGE_ROLE_PAGE_ID, roleId), () =>
             {
                 ...
                 if(roleId > 0 && roleId != this._options.Value.SuperAdministratorRoleId)
                 {
        ...
        public void RemovePageCacheByPageId(long pageId)
        {
            ...
            _cacheService.Remove(string.Format(BMS_PAGE_ROLE_PAGE_ID, this._options.Value.SuperAdministratorRoleId));
        }
