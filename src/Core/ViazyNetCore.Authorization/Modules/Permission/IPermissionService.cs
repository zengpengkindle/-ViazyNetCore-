...
namespace ViazyNetCore.Authorization.Modules
{
    ...
    public interface IPermissionService
    {
        ...
        Task<IEnumerable<BmsOwnerPermission>> GetPermissionsInUserRole(long ownerId, OwnerType ownerType);
        ...
        /// <param name="ownerId">拥有者Id</param>
        /// <param name="ownerType">拥有者所属类别</param>
        Task UpdatePermissionsInUserRole(IEnumerable<string>? permissionItemKeys, long ownerId, OwnerType ownerType);
        ...
        /// <returns></returns>
        Task<IEnumerable<BmsOwnerPermission>> ResolveUserPermission(long userId);
        ...
        Task<bool> Check(IUser<long> currentUser, string permissionItemKey);
        /// <summary>
        /// 检查用户是否有权限进行某项操作
        /// </summary>
        /// <param name="currentUser">当前用户</param>
